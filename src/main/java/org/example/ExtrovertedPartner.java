    ...
    public void respondStep1(int choice) {
        switch (choice) {
            case 1:
                ...
                System.out.println(getName() + ": \"아유 전혀요! 날씨가 좋아서 걸어오기 딱 좋던데요? " + getPlayerName() + " 씨는요?\"");
                changeHeartRate(15);
                changeTensionLevel(5);
                break;
            case 2:
                System.out.println("\n[당신의 선택] \"혹시 MBTI가 C.U.T.E 이신가요? ㅎㅎ\"");
                System.out.println(getName() + ": \"아하하하! 뭐야 진짜 웃긴다 ㅋㅋㅋㅋ 저 그런 드립 완전 좋아해요!\"");
                changeHeartRate(25);
    ...
    public void respondStep2(int choice) {
        switch (choice) {
            case 1:
                ...
                System.out.println(getName() + ": \"전 주말에 무조건 밖에 나가요! 핫플 카페 가거나 친구들이랑 한잔하는 거 좋아해요!\"");
                changeHeartRate(15);
                changeTensionLevel(10);
                break;
            case 2:
                System.out.println("\n[당신의 선택] 가방에서 슬쩍 고양이 키링 선물을 건넨다.");
                System.out.println(getName() + ": \"헐 대박! 이거 요즘 구하기 진짜 힘든 핫템인데! 감동이에요 ㅠㅠ 가방에 바로 달아야지!\"");
                changeHeartRate(25);
    ...
    public void respondStep3(int choice) {
        switch (choice) {
            case 1:
                ...
                System.out.println(getName() + ": \"좋죠! 이번 주 토요일 어때요? 저 힙한 맛집 아는데 거기로 예약할게요!\"");
                changeHeartRate(20);
                break;
            case 2:
                System.out.println("\n[당신의 선택] 슬쩍 손을 터치한다.");
                System.out.println(getName() + ": \"(당황하지 않고 손을 마주 잡으며 따뜻하게 미소 지음) 와, 손 되게 따뜻하시네요? ㅎㅎ\"");
                changeHeartRate(30);
