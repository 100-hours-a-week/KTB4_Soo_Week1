    ...
    public String respondStep1(int choice) {
        ...
        switch (choice) {
            case 1:
                ...
                sb.append(getName()).append(": \"아뇨? 전혀요? ").append(getPlayerName()).append(" 씨 만나러 오는 길인데 힘들 리가 없잖아요?\"");

                changeHeartRate(15);
                break;
            case 2:
                sb.append("\n[당신의 선택] \"혹시 MBTI가 C.U.T.E 이신가요? ㅎㅎ\"\n");
                sb.append(getName()).append(": \"아하하하! 진짜 재밌으시다. 나 오직 ").append(getPlayerName()).append(" 씨만의 CUTE가 될래요.\"");
    ...
    public String respondStep2(int choice) {
        ...
        switch (choice) {
            case 1:
                ...
                sb.append(getName()).append(": \"전 ").append(getPlayerName()).append(" 씨 연락 기다리는 거 말고는 주말 계획 다 비워둘 건데요?\"");
            ...
            case 2:
                ...
                sb.append(getName()).append(": \"선물...? (갑자기 정색) 혹시 다른 사람한테도 이런 거 주면서 환장하게 만들고 다녀요? 누군지 말해봐요.\"\n");
                sb.append("[시스템] 선물을 주자 뜬금없이 과도한 집착과 질투심이 폭발합니다!");
    ...
    public String respondStep3(int choice) {
        ...
        switch (choice) {
            case 1:
                ...
                sb.append(getName()).append(": \"당연한 걸 왜 물어봐요? 우린 내일도 모레도 매일 만나야죠. 약속 지켜요?\"");

                changeHeartRate(25);
                break;
            case 2:
                sb.append("\n[당신의 선택] 슬쩍 ").append(getName()).append(" 님의 손을 터치한다.\n");
                sb.append(getName()).append(": \"(손을 꽉 움켜쥐며 절대 안 놓아줌) 먼저 만진 거예요. 평생 못 놓아줘요.\"");
